...
(3,  '17105885A', 'Pedro', 'Heller', 'Pagac', 'Almería', 'C/ Estrella fugaz', NULL, '2000-10-05', 'H'),
(4,  '04233869Y', 'José', 'Koss', 'Bayer', 'Almería', 'C/ Júpiter', '628349590', '1998-01-28', 'H'),
(5,  '97258166K', 'Ismael', 'Strosin', 'Turcotte', 'Almería', 'C/ Neptuno', NULL, '1999-05-24', 'H'),
(6,  '82842571K', 'Ramón', 'Herzog', 'Tremblay', 'Almería', 'C/ Urano', '626351429', '1996-11-21', 'H'),
(7,  '46900725E', 'Daniel', 'Herman', 'Pacocha', 'Almería', 'C/ Andarax', '679837625', '1997-04-26', 'H'),
(8,  '11578526G', 'Inma', 'Lakin', 'Yundt', 'Almería', 'C/ Picos de Europa', '678652431', '1998-09-01', 'M'),
(9,  '79089577Y', 'Juan', 'Gutiérrez', 'López', 'Almería', 'C/ Los pinos', '678652431', '1998-01-01', 'H'),
(10, '41491230N', 'Antonio', 'Domínguez', 'Guerrero', 'Almería', 'C/ Cabo de Gata', '626652498', '1999-02-11', 'H'),
(11, '64753215G', 'Irene', 'Hernández', 'Martínez', 'Almería', 'C/ Zapillo', '628452384', '1996-03-12', 'M'),
(12, '85135690V', 'Sonia', 'Gea', 'Ruiz', 'Almería', 'C/ Mercurio', '678812017', '1995-04-13', 'M');
...
/* Asignatura */
INSERT INTO asignatura (id_asignatura,nombre, creditos, tipo, curso, semestre, id_grado_fk, id_departamento_fk)
VALUES 
(1,  'Álgebra lineal y matemática discreta', 6, 'básica',1, 1, NULL, 4),
...
(13, 'Ingeniería del Software', 6, 'obligatoria', 2, 1, 4, 4),
(14, 'Sistemas Inteligentes',6, 'obligatoria', 2, 1, 3, 4),
(15, 'Sistemas Operativos',6, 'obligatoria', 2, 1, 4, 4),
(16, 'Bases de Datos',6, 'básica',      2, 2, 4, 4),
(17, 'Estructura de Datos y Algoritmos II',6, 'obligatoria', 2, 2, 4, 4),
...
(20, 'Programación de Servicios Software', 6, 'obligatoria', 2, 2, 4, 4),
(21, 'Desarrollo de interfaces de usuario', 6, 'obligatoria', 3, 1, 4, 4),
...
(52, 'Biología celular', 6, 'básica', 1, 1, NULL, 7),
...
/* Curso escolar */
INSERT INTO curso_escolar (id_curso_escolar, ano_inicio, ano_fin)
VALUES 
(1, 2014, 2015),
(2, 2015, 2016),
(3, 2016, 2017),
